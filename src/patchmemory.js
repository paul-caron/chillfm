let presetPatches = [{"name":"brassySound","settings":{"range":["0","0.44","0.29","0","0.29","0","0.1","0.1","0.1","0.1","0.4","0.4","0.4","0.4","0.7","0.7","0.7","0.7","2","2","2","2","341","0","0","0","0","324","0","0.01","0"],"select":["0","sine","sine","sine","sine"],"checkbox":[false,false,false,false,false],"number":["1","1","1","1","0","0","0","0"]}},{"name":"meow-animal","settings":{"range":["0","1","0.38","0","0","0","0.1","0.1","0.1","0.1","0.4","0.4","0.4","0.4","0.7","0.7","0.7","0.7","0.85","1.8","2","0.67","0","0","0","446","0","0","621.42","0.01","0"],"select":["2","sine","sine","sine","sine"],"checkbox":[false,false,false,false,false],"number":["1","1","1","1","0","0","0","0"]}},{"name":"organSound","settings":{"range":["0","0.19","0.7","0.53","0.32","0.17","0.01","0.08","0.01","0.03","0.1","0.15","0.4","0.4","0.93","0.88","0.74","0.7","0.46","0.69","0.57","0.73","0","0","0","0","0","0","0","0.01","0"],"select":["0","sine","sine","sine","sine"],"checkbox":[false,false,false,false,false],"number":["1","2","3","5","4","-3","3","-1"]}},{"name":"organSound2","settings":{"range":["0","0.19","0.7","0.53","0.32","0.05","0.07","0.08","0.01","0.03","0.1","0.15","0.4","0.4","1","0.93","0.85","0.7","0.46","0.69","0.57","0.73","0","0","0","0","0","0","0","7.39","179.03"],"select":["0","sine","sine","sine","sine"],"checkbox":[false,false,false,false,true],"number":["1","2","3","5","4","-3","3","-1"]}},{"name":"boopy","settings":{"range":["0","0.19","0.7","0.53","0.32","0","0.01","0.08","0.01","0.03","0.1","0.15","0.4","0.4","0.59","0.48","0.42","0.08","0.46","0.69","0.57","0.73","0","0","0","269","423","446","168.18","0.01","0"],"select":["0","sine","sine","sine","sine"],"checkbox":[false,false,false,false,false],"number":["1","2","5","0.25","3","-3","3","-3"]}},{"name":"springy","settings":{"range":["0","0.19","0.7","0.53","0.32","0","0.01","0.08","0.01","0.03","0.1","0.15","0.4","0.4","0.59","0.48","0.42","0.08","0.46","0.69","0.57","0.73","0","0","0","269","423","446","168.18","5.31","197.16"],"select":["1","sine","sine","sine","square"],"checkbox":[false,true,false,false,false],"number":["1","2","5","0.25","3","-3","3","-3"]}},{"name":"bell","settings":{"range":["0","0.72","0.33","0","0.31","0","0.1","0.1","0.01","0.1","0.4","0.4","0.11","0.26","0.41","0.33","0.01","0.01","1.21","0.87","0.21","0.38","292","0","0","0","0","106","50.33","0.01","0"],"select":["1","sine","sine","sine","square"],"checkbox":[false,false,false,false,false],"number":["0","2","2","8","2","-2","3","-3"]}},{"name":"brassySound2","settings":{"range":["0","0.44","0.29","0","0.29","0","0.1","0.1","0.1","0.1","0.4","0.4","0.4","0.4","0.7","0.7","0.7","0.7","2","2","2","2","341","0","0","0","0","324","23.14","0.01","0"],"select":["0","sine","sine","sine","sine"],"checkbox":[false,false,false,false,false],"number":["1","1","1","1","3","-4","5","-5"]}},{"name":"sync","settings":{"range":["0","1","0.23","0","0","0","0.1","0.1","0.1","0.1","0.4","0.4","0.4","0.4","0.7","0.7","0.7","0.7","2","2","2","2","0","0","0","858","0","0","0","0.01","0"],"select":["0","square","sine","sine","square"],"checkbox":[false,false,false,false,false],"number":["1","1","1","1","0","0","0","0"]}},{"name":"sync2","settings":{"range":["0","1","0.23","0","0","0","0.1","0.1","0.1","0.1","0.4","0.4","0.4","0.4","0.7","0.7","0.7","0.7","2","2","2","2","0","0","0","858","0","0","0","0.01","0"],"select":["0","square","sine","sine","square"],"checkbox":[false,false,false,false,false],"number":["1","1","1","0.25","0","0","0","0"]}},{"name":"padSound","settings":{"range":["0","0.44","0.29","0","0.29","0","0.91","1.22","1.08","1.03","0.75","0.54","0.4","0.4","1","1","1","1","2.43","2.68","2","2.55","341","0","0","0","0","324","0","13.73","224.36"],"select":["1","sine","sawtooth","sine","sine"],"checkbox":[false,false,false,false,false],"number":["1","1","1","1","0","4","-10","10"]}},{"name":"stringy","settings":{"range":["0","0.52","0.27","0.24","0.28","0","0.1","0.1","0.1","0.3","0.4","0.4","0.4","0.4","0.67","0.54","0.47","0.38","0.65","0.64","0.71","1.55","0","0","0","1000","1000","1000","0","0.01","0"],"select":["1","sawtooth","sawtooth","sawtooth","sawtooth"],"checkbox":[false,false,false,false,false],"number":["1","1","2","1","0","2","-5","7"]}},{"name":"fluteSound","settings":{"range":["0","1","0","0","0","0.23","0.1","0.01","0.01","0.11","0.01","0.01","0.01","0.4","1","0.01","0.01","1","0.01","0.01","0.01","0.42","0","0","0","0","0","0","127.98","0.01","0"],"select":["1","sine","sine","sine","sine"],"checkbox":[false,false,false,false,false],"number":["1","1","1","1","0","0","0","0"]}},{"name":"kickSound","settings":{"range":["0","0.59","0","1","0","0","0.1","0.1","0.13","0.16","0.01","0.4","0.4","0.32","0.01","0.01","0.01","0.01","0.01","0.01","0.01","0.01","0","0","241","0","0","445","49.5","0.01","0"],"select":["-1","sine","sine","sine","sine"],"checkbox":[false,false,false,false,false],"number":["1","0.5","1","0.25","0","0","0","0"]}},{"name":"clappySound","settings":{"range":["0","0.59","0","1","0","0","0.1","0.1","0.13","0.16","0.01","0.2","0.2","0.16","0.01","0.01","0.01","0.01","0.01","0.01","0.01","0.01","0","0","241","0","0","445","1000","0.01","0"],"select":["0","sine","sine","sine","sine"],"checkbox":[false,false,false,false,false],"number":["1","8.13","1.1","0.37","0","0","0","0"]}},{"name":"saw","settings":{"range":["0","0.52","0.27","0.24","0.28","0","0.1","0.1","0.1","0.3","0.4","0.4","0.4","0.4","1","1","1","1","0.39","0.44","0.33","1.55","0","0","0","0","0","0","0","4.03","351.26"],"select":["0","sawtooth","sawtooth","sawtooth","sine"],"checkbox":[true,false,false,false,false],"number":["1","1","1","1","0","5","-5","10"]}},{"name":"brassylfo","settings":{"range":["0","0.44","0.29","0","0.29","0","0.1","0.1","0.1","0.1","0.4","0.4","0.4","0.4","0.7","0.7","0.7","0.7","2","2","2","2","341","0","0","0","0","981","276.96","3.4","179.03"],"select":["0","sine","sine","sine","sine"],"checkbox":[false,false,false,false,true],"number":["1","1","1","1","4","-5","10","-10"]}},{"name":"windylfo","settings":{"range":["0","0.44","0.29","0","0.29","0","0.1","0.1","0.1","0.1","0.4","0.4","0.4","0.4","0.7","0.7","0.7","0.7","2","2","2","2","341","0","0","0","0","88","267.89","1.32","179.03"],"select":["0","sine","sine","sine","sine"],"checkbox":[false,false,false,false,true],"number":["1","1","2","1","4","-5","10","-10"]}},{"name":"phonky","settings":{"range":["0","1","0.45","0","0","0.36","0.1","0.1","0.1","0.1","0.4","0.4","0.4","0.44","0.01","0.01","0.01","0.01","0.6","0.01","0.01","0.52","0","0","0","0","0","0","0","0.01","0"],"select":["1","square","sine","sine","square"],"checkbox":[true,false,false,false,false],"number":["1","1","1","0.75","0","0","0","0"]}},{"name":"phonky2","settings":{"range":["0","1","0.45","0","0","0.36","0.1","0.1","0.1","0.1","0.4","0.4","0.4","0.44","0.01","0.01","0.01","0.01","0.6","0.01","0.01","0.52","0","0","0","0","0","0","27.67","0.01","0"],"select":["1","square","sine","sine","square"],"checkbox":[true,false,false,false,false],"number":["1","1","1","0.75","0","0","0","0"]}},{"name":"bassSound","settings":{"range":["0","1","0","0.47","0","0","0.01","0.01","0.01","0.01","0.01","3","1.1","1.01","0.01","0.01","0.7","0.7","2","0.23","0.08","0.17","0","0","33","0","0","20","0","0.01","0"],"select":["0","sine","sine","sine","sawtooth"],"checkbox":[false,false,false,false,false],"number":["1","1","0.5","0.5","0","0","0","0"]}}];
